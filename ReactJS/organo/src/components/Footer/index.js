...
const Footer = () => {
    return (
        <div className="footer__wrapper">
            ...
            <p className="footer__text">© 2022 Organo - Desenvolvido no curso da <a className="footer__text--ancor" href="https://github.com/lucassmaniotto/React-Cursos/tree/main/">Alura</a>.</p>
        </div>
    );
};
